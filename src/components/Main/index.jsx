      ...
      <section>
        <div className="grid grid-cols-2 max-md:grid-cols-1">
          <div className="flex justify-center items-center max-md:order-last">
            <div className="flex flex-col w-8/12 gap-10 max-xl:gap-8 max-lg:gap-6 max-md:py-14 max-md:px-12 max-md:w-full max-xs:px-4">
